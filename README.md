...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-litedown-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-litedown-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install r-litedown
```
...
It is possible to list all of the versions of `r-litedown` available on your platform:
...
```
pixi search r-litedown --channel conda-forge
```
